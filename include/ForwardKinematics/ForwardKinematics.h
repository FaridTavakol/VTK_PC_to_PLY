...
public:
    ...
    Eigen::Matrix3Xf get_SubWorkspace(Eigen::Matrix3Xf RCM_PC, Eigen::Vector3d EP_inImagerCoordinate, Eigen::Matrix4d registration, double probe_init);
    ...
    Eigen::Matrix3Xf check_PointCloud_IK(Eigen::Matrix3Xf Validated_PC, Eigen::Vector3d EP_inRobotCoordinate);
};
